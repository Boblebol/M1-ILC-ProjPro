...
public class TraitementTest {
	public static void main (String[] args) throws DBException, JSONException {
		...
		System.out.println(MagasinsTraitements.AddMagasin("magasin1@gmail.com", "mdp", "mag1", "adresse1",10,10));
		System.out.println("### Création magasin mag2 ###");
		System.out.println(MagasinsTraitements.AddMagasin("magasin2@gmail.com", "mdp", "mag2", "adresse2",10,10));
