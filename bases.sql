-- une promotion sera ajoutée dans cette table (not null à ajouter)
...
(
    ...
    dureeValidite   	INT, --duree de validite de la promo -> si non renseignée 24h  
    -- LE MAGASIN
    ...
    -- LE CREATEUR
    idUtilisateur       INT NOT NULL FOREIGN KEY REFERENCES Utilisateurs(idUtilisateur)
...
(
	...
	-- L'UTILISATEUR
	idUtilisateur		INT NOT NULL FOREIGN KEY REFERENCES Utilisateurs(idUtilisateur) -- id de l'utilisateur
	-- LE SUIVI
	marque          	VARCHAR(50), -- marque du produit
	catégorie       	VARCHAR(50), -- catégorie du produit 
    poseurDAnnonce		INT NOT NULL FOREIGN KEY REFERENCES Utilisateurs(idUtilisateur) -- un autre utilisateur
)
